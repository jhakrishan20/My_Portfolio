                    ...
                    <div className="row gx-5 align-items-center">
                        <div className="col-xxl-5">
                            ...
                            <div className="text-center text-xxl-start">
                                ...
                                <div className="fs-3 fw-light text-muted">Dive into Ideas that Matters.</div>
                                <h1 className="display-3 fw-bolder mb-5">
                                    <span className="text-gradient d-inline">Insights, Inspiration, and Ideas Worth Sharing</span>
                                </h1>
                        ...
                        <div className="col-xxl-7">
                            ...
                            <div className="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div className="profile bg-gradient-primary-to-secondary">
                                    <img className="profile-img" src={blog_img} alt="Profile" />
